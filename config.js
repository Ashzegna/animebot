...
const botTexts = {
  ...
  shareInvitation: '🔍✨ Отправь этот тест другу, чтобы узнать его сверхспособность и вашу совместимость! Это как сложить два паззла вместе - интересно, дополните ли вы друг друга?',
  customQuestionPrompt: '❓✨ Добавь свой персональный вопрос в тест. Твой друг не будет знать, что это твой вопрос, а ты сможешь увидеть его ответ!',
  shareLinkMessage: '🔗✨ Готово! Отправь эту ссылку своему другу или второй половинке. Когда они пройдут тест, вы оба узнаете о вашей совместимости:',
  receivedTestIntro: '👀✨ Привет! Твой друг предлагает тебе пройти тест и узнать, какая сверхспособность скрыта в твоей личности! А после вы узнаете, насколько вы совместимы! ✨',
  testCompleted: '✅✨ Тест завершен!',
  surpriseMessage: '😲✨ Сюрприз! Твой друг, который отправил тебе этот тест, тоже узнает твою сверхспособность! Хочешь увидеть его результат и вашу совместимость?',
  friendCompletedTest: '🎊✨ Твой друг прошел тест! Вот результаты:',
  compatibilityIntro: '💫✨ Ваша совместимость как два паззла из разных коробок:',
  aboutBot: 'ℹ️ О боте',
  aboutBotText: 'Этот бот помогает узнать, какая скрытая сверхспособность есть у тебя в отношениях с людьми. Пройди тест, а затем отправь его друзьям или второй половинке, чтобы узнать вашу совместимость и то, как ваши сверхспособности дополняют друг друга!',
  aboutSong: '🎵 О песне "Паззлы"',
  aboutSongText: 'Песня "Паззлы" рассказывает об особенных отношениях, которые не вписываются в стандартные рамки. "Мы с тобой два пазла из разных коробок, края не совпадают, но узор один". Послушать полную версию можно по ссылке: https://music.yandex.ru/album/35714443/track/136874790'
};
